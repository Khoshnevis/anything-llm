...
import XehnAILogoLight from "./media/logo/anything-llm.png";
import XehnAILogoDark from "./media/logo/anything-llm-dark.png";
  ...
  async function fetchInstanceLogo() {
    try {
      ...
      if (logoURL) {
        ...
        localStorage.getItem("theme") !== "default"
          ? setLogo(XehnAILogoDark)
          : setLogo(XehnAILogoLight);
