const TRANSLATIONS = {
  onboarding: {
    ...
    llm: {
      ...
      description:
        "XehnAI can work with many LLM providers. This will be the service which handles chatting.",
    },
    userSetup: {
      title: "User Setup",
    ...
    survey: {
      title: "Welcome to XehnAI",
      description: "Help us make XehnAI built for your needs. Optional.",

      email: "What's your email?",
      useCase: "What will you use XehnAI for?",
      useCaseWork: "For work",
      useCasePersonal: "For personal use",
      useCaseOther: "Other",
      comment: "How did you hear about XehnAI?",
      commentPlaceholder:
    ...
    workspace: {
      ...
      description:
        "Create your first workspace and get started with XehnAI.",
    },
  },
  common: {
  ...
  settings: {
    ...
    audio: {
      stt: {
        ...
        description:
          "Here you can specify what kind of text-to-speech and speech-to-text providers you would want to use in your XehnAI experience. By default, we use the browser's built in support for these services, but you may want to use others.",
        provider: "Provider",
        native_name: "System native",
        native_desc: "Uses your browser's built in STT service if supported.",
        native_note: "There is no configuration needed for this provider.",
      },
      tts: {
        title: "Text-to-speech Preference",
        description:
          "Here you can specify what kind of text-to-speech providers you would want to use in your XehnAI experience. By default, we use the browser's built in support for these services, but you may want to use others.",
        provider: "Provider",
        native_name: "System native",
        native_desc: "Uses your browser's built in TTS service if supported.",
        native_note: "There is no configuration needed for this provider.",
      },
    },
  },
  ...
  welcomeMessage: {
    part1:
      "Welcome to XehnAI, an open-source AI tool that turns anything into a trained chatbot you can query and chat with. XehnAI is BYOK (bring-your-own-keys) software so there is no subscription, fee, or charges for this software outside of the services you want to use with it.",
    part2:
      "XehnAI is the easiest way to put powerful AI products like OpenAi, GPT-4, LangChain, PineconeDB, ChromaDB, and other services together in a neat package with no fuss to increase your productivity by 100x.",
    part3:
      "XehnAI can run totally locally on your machine with little overhead you wont even notice it's there! No GPU needed. Cloud and on-premises installation is available as well.\nThe AI tooling ecosystem gets more powerful everyday. XehnAI makes it easy to use.",
  ...
  "main-page": {
    ...
    checklist: {
      ...
      completed: "You're on your way to becoming a XehnAI expert!",
      dismiss: "close",
      tasks: {
        create_workspace: {
  ...
  customization: {
    interface: {
      ...
      description: "Set your UI preferences for XehnAI.",
    },
    branding: {
      title: "Branding & Whitelabeling",
      description:
        "White-label your XehnAI instance with custom branding.",
    },
    chat: {
      title: "Chat",
      description: "Set your chat preferences for XehnAI.",
      auto_submit: {
    ...
    items: {
      ...
      "display-language": {
        ...
        description:
          "Select the preferred language to render XehnAI's UI in - when translations are available.",
      },
      logo: {
        title: "Application logo",
        description: "Upload a custom logo to display across the UI.",
        add: "Add logo",
        recommended: "Recommended: PNG or SVG — at least 256×256px",
        remove: "Remove logo",
      ...
      "welcome-messages": {
        ...
        user: "user",
        message: "message",
        assistant: "XehnAI Chat Assistant",
  ...
  api: {
    title: "API Keys",
    description:
      "API keys allow the holder to programmatically access and manage this XehnAI instance.",
  ...
  llm: {
    title: "LLM Preference",
    description:
      "These are the credentials and settings for your preferred LLM chat & embedding provider. It is important that these keys are current and correct, or else XehnAI will not function properly.",
  ...
  transcription: {
    ...
    "warn-start":
      "Using the local whisper model on machines with limited RAM or CPU can stall XehnAI when processing media files.",
    "warn-recommend":
  ...
  embedding: {
    ...
    "desc-end":
      "Embedding is the process of turning text into vectors. These credentials are required to turn your files and prompts into a format which XehnAI can use to process.",
    provider: {
  ...
  vector: {
    ...
    description:
      "These are the credentials and settings for how your XehnAI instance will function. It's important these keys are current and correct.",
    provider: {
  ...
  security: {
    ...
    password: {
      ...
      description:
        "Protect your XehnAI instance with a password. If you forget this there is no recovery method so ensure you save this password.",
  ...
  privacy: {
    ...
    description:
      "This is your configuration for how connected third party providers and XehnAI handle your data.",
    llm: "LLM Selection",
  ...
  connectors: {
    ...
    upload: {
      ...
      "privacy-notice":
        "These files will be uploaded to the document processor running on this XehnAI instance. These files are not sent or shared with a third party.",
    },
    pinning: {
      what_pinning: "What is document pinning?",
      pin_explained_block1:
        "When you <b>pin</b> a document in XehnAI we will inject the entire content of the document into your prompt window for your LLM to fully comprehend.",
      pin_explained_block2:
        "This works best with <b>large-context models</b> or small files that are critical to its knowledge-base.",
      pin_explained_block3:
        "If you are not getting the answers you desire from XehnAI by default then pinning is a great way to get higher quality answers in a click.",
      accept: "Okay, got it",
    },
    watching: {
      what_watching: "What does watching a document do?",
      watch_explained_block1:
        "When you <b>watch</b> a document in XehnAI we will <i>automatically</i> sync your document content from it's original source on regular intervals. This will automatically update the content in every workspace where this file is managed.",
    ...
    publish: {
      ...
      generic: {
        unauthenticated: {
          ...
          description:
            "You need to authenticate with the XehnAI Community Hub before publishing items.",
