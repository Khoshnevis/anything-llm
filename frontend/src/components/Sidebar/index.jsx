        ...
        >
          <div className="flex flex-col h-full overflow-x-hidden">
            <div className="flex-grow flex flex-col min-w-[235px]">
              ...
              <div className="absolute bottom-0 left-0 right-0 pt-4 pb-6 rounded-b-[16px] bg-theme-bg-sidebar bg-opacity-80 backdrop-filter backdrop-blur-md z-1">
                <Footer />
              </div>
            </div>
          </div>
        ...
        >
          <div className="w-full h-full flex flex-col overflow-x-hidden items-between">
            ...
            <div className="h-full flex flex-col w-full justify-between pt-4 ">
              ...
              <div className="z-99 absolute bottom-0 left-0 right-0 pt-2 pb-8 rounded-br-[26px] bg-theme-bg-sidebar bg-opacity-80 backdrop-filter backdrop-blur-md">
                <Footer />
              </div>
            </div>
          </div>
